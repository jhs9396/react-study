...
export const Draw = ({shape, color}) => {
    ...
    let handleMouseDown = (evt) => {
        setActions({type: shape, color: color, x1: evt.nativeEvent.offsetX, y1: evt.nativeEvent.offsetY, x2: evt.nativeEvent.offsetX,
    ...
    let handleMouseUp = (evt) => {
        ...
        setShapes([{type:shape, color: color, x1: actions.x1, y1: actions.y1, x2: actions.x2, y2: actions.y2}].concat(shapes))
        setActions(null)
    }
